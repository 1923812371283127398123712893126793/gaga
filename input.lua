...
AccessCodeBox.Size = UDim2.new(1, -20, 0, 30)
AccessCodeBox.Position = UDim2.new(0, 10, 0, 40)
AccessCodeBox.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
AccessCodeBox.TextColor3 = Color3.fromRGB(255, 255, 255)
AccessCodeBox.PlaceholderText = "Access Code"
AccessCodeBox.Text = ""
AccessCodeBox.Parent = Frame

local GenerateButton = Instance.new("TextButton")
GenerateButton.Size = UDim2.new(1, -20, 0, 30)
GenerateButton.Position = UDim2.new(0, 10, 0, 80)
GenerateButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
GenerateButton.TextColor3 = Color3.fromRGB(255, 255, 255)
GenerateButton.Text = "Generate Private Server"
GenerateButton.Parent = Frame

local UICornerGen = Instance.new("UICorner")
UICornerGen.CornerRadius = UDim.new(0, 5)
UICornerGen.Parent = GenerateButton

local JoinButton = Instance.new("TextButton")
JoinButton.Size = UDim2.new(1, -20, 0, 30)
JoinButton.Position = UDim2.new(0, 10, 0, 120)
JoinButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
JoinButton.TextColor3 = Color3.fromRGB(255, 255, 255)
JoinButton.Text = "Join Private Server"
JoinButton.Parent = Frame

local UICornerJoin = Instance.new("UICorner")
UICornerJoin.CornerRadius = UDim.new(0, 5)
